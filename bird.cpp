 ...
 ****************************************************************/
int randomBirdInt(int min, int max)
{
   assert(min < max);
...
double randomBirdFloat(double min, double max)
{
   assert(min <= max);
 ...
 * BIRD constructor
 ******************************************************************/
Bird::Bird(double radius, double speed, int points, birdType type) {
   ...
   switch(type) 
   {
      case STANDARD:
         ...
         pt.setY(randomBirdFloat(dimensions.getY() * 0.25, dimensions.getY() * 0.75));
         pt.setX(0.0);

         // set the velocity
         v.setDx(randomBirdFloat(speed - 0.5, speed + 0.5));
         v.setDy(randomBirdFloat(-speed / 5.0, speed / 5.0));
         break;
      case FLOATER:
         // floaters start on the lower part of the screen because they go up with time
         pt.setY(randomBirdFloat(dimensions.getY() * 0.50, dimensions.getY() * 0.95));
         pt.setX(0.0);

         // set the velocity
         v.setDx(randomBirdFloat(speed - 0.5, speed + 0.5));
         v.setDy(randomBirdFloat(-speed / 3.0, 0.0));
         break;
      case SINKER:
